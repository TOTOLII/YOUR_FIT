                            ...
                            <div class="widget widget-sidebar">
                                ...
                                <div class="link-widget">
                                    <ul>
                                        ...
                                        <li><a href="#">상품 관리 <span>></span></a></li>
                                        <li><a href="#">광고 관리 <span>></span></a></li>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="page-wrapper">
                        	<div class="title-group">
	                        	<h2 class="content content-title"><i class="fa fa-info-circle" style="margin-right: 10px"></i>가려진 다이어트 꿀팁 관리</h2>
	        					...
	        					<p id="totlecontent">(가려짐 : ${totalContents}건)</p>
										...
										<fieldset class="sch2 clfix">
											<select id="statusYN" class="statusYN">
												...
												<option value="Y" selected="selected">게시중</option>
